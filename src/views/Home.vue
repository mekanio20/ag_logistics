                        ...
                        <div class="grid xl:grid-cols-2 grid-cols-1 gap-4">
                            <div class="p-4 border flex items-center space-x-6"
                                ...
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 26 19" fill="none"
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 20 21" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 24 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
