<template>
    <div class="w-full relative dark:bg-m_black-100">
        ...
        <div class="w-full relative sm:top-[120px] top-[100px]">
            <div class="w-full h-[600px] relative select-none">
                <swiper :slidesPerView="1" :modules="modules" :speed="2000" :loop="true"
                    ...
                    <swiper-slide v-for="(item, index) in galleryItems[this.$i18n.locale]" :key="item.id"
                        class="w-full h-full">
                        ...
                        <div class="container relative">
                            <div
                                ...
                                <router-link to="/about"
                                    class="font-manjari font-medium lg:text-lg text-sm hover:bg-m_blue-100 duration-300 text-white py-4 px-10 bg-m_blue-100">
                                    {{ $t('home.title1') }}
                                </router-link>
                            </div>
                        </div>
            ...
            <div class="w-full absolute z-10">
                <div
                    class="absolute sm:bottom-[300px] bottom-0 left-6 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-m_gray-500 dark:bg-black rounded-full flex items-center justify-center cursor-pointer hover:bg-m_blue-100 duration-300 prev-slider">
                ...
                <div
                    class="absolute sm:bottom-[300px] bottom-0 right-6 transform translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-m_gray-500 dark:bg-black rounded-full flex items-center justify-center cursor-pointer hover:bg-m_blue-100 duration-300 next-slider">
                    <svg class="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
        ...
        <div class="w-full relative top-[100px]">
            ...
            <div class="bg-white dark:bg-m_black-100">
                <div
                    ...
                    <div class="flex-1 flex flex-col space-y-8">
                        <h3
                            class="font-poppins font-semibold uppercase text-m_blue-100 lg:text-base text-sm border-b-2 border-m_blue-100 w-fit">
                            {{ $t('home.title13') }}
                        </h3>
                        <h1 class="font-poppins font-bold lg:text-3xl text-2xl pb-3 dark:text-white">
                            {{ $t('home.title14') }}
                        ...
                        <div class="grid xl:grid-cols-2 grid-cols-1 gap-4">
                            <div class="p-4 border flex items-center space-x-6"
                                ...
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 26 19"
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 20 21"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="p-4 border flex items-center space-x-6"
                                style="border-color: rgba(0, 0, 0, 0.06);">
                                <div class="rounded-full p-3 bg-m_white-200 dark:bg-black">
                                    <svg class="w-[20px] h-[20px] fill-m_blue-100 dark:fill-white" viewBox="0 0 24 20"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="stroke-[#2A34E9] dark:stroke-white"
            ...
            <!-- Statistic -->
            <div class="container bg-m_blue-100 py-10 px-6">
